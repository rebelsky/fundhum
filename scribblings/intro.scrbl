...
Welcome to @italic{A Functional Approach to the Digital Humanities},
which we will refer to as @italic{FunDHum}.  FunDHum provides a
workshop-style introduction to computer science grounded in examples
from the digital humanities and employing a functional programming
approach using the Racket programming language.  What does that all
mean?  Let's unpack some key terms.

@section[#:style 'unnumbered]{Computer Science}
...
for both correctness and efficient use of resources.  Whether or
not you continue your study of computer science beyond this course,
I hope that FunDHum will help you think you think more carefully
...
Since you will write programs, we will also explore some issues
...
artificial language, we will also consider issues of style and elegance.
...
Just in case it wasn't clear: While you will develop a wide variety
of computer programs in FunDHum, the primary role of our programming
exercises is to help you develop skills at algorithmic thinking.

@section[#:style 'unnumbered]{Digital Humanities}
...
Humanities.  But what are the Digital Humanities?  Perhaps we should
...
religion, and art.  Of course, scientists and social scientists
might also study these areas.  However, humanists and scientists
approach their study differently.  While scientists tend to employ
the scientific or experimental method, humanists often attend more
to the particular details or broader contexts of individual works,
frequently guided by an underlying theory or framework.

What about the digital humanities?  Because the field is evolving,
the community has not agreed upon a consistent definition.  That's
almost certainly a good thing; definitions can limit possibilities,
and fields need have room to grow.  At the same time, some limits
are useful.  For the sake of FunDHum, we will consider the aspects
of the digital humanities that relate to the ways in which algorithmic
thinking and digital tools can contribute to humanistic work,
particularly humanistic work involve text written in natural language.
I use the term "contribute" carefully; as a computer scientist, I
know that computers cannot replace the careful thought and analysis
that undergird humanistic study.  However, these technologies can
reveal new topics and modes of inquiry and provide new modalities
for presenting results.

Let's consider a few examples.

An early form of digital humanities involved using computers to
find patterns in moderate-sized or large corpora, such as the works
of Shakespeare or a digitized collection of 18th century British
novels.  This form of analysis is often termed "distant reading"
to contrast it with the close reading that is core to many forms
of humanistic study.  It also suggests the potential benefits of
stepping back and looking at a larger group of works.  While distant
reading incorporates a wide variety of practices, one of the more
popular is that of "topic modeling", the use of computers to find
groups of words that tend to appear together.  Of course, the topics
themselves are not intended to serve as the final "result".  Rather,
discovering an unusual grouping of words may lead the scholar to a
set of readings which she can then explore more closely through
traditional techniques.  She may discover insight from the particular
grouping of words.  She may find the unexpected connections between
works leads her in do directions.  She may conclude that the
relationships appear to be specious.
...
role in the play that they influence the action.  Mapping tools need
...
place names in the songs of Kendrick Lamar.  In many such situations,
...
@section[#:style 'unnumbered]{Workshop-style learning}
...
a few pages that provide some background information.  While, in a
few cases, we will rely on articles written by others, most frequently
you will read materials written specifically for this work.  Class
time is then devoted to students working in pairs on a series of
problems.

Why pairs?  Because research suggests that programmers work better
in pairs, in both the classroom and in regular practice.  How much
better?  Studies suggest that two people working together are
regularly more productive than two people working separately.  It's
not just that "two heads are better than one"; we also know that
having to describe a thought process to someone else improves that
thought process and helps find flaws.

If you are reading through FunDHum on your own, I suggest that you
do your best to follow a similar approach.  You won't learn this
material by just reading, so make sure that you work through the
various problems.  You may even want to design some new problems.
If you're fortunate enough to have a friend who might be interested
in these topics, try to work as a pair.

@section[#:style 'unnumbered]{Functional programming in the Racket Programming Language}

You will learn methods of algorithmic thinking, in part, by writing
programs that represent your algorithms and data structures in a
formal language, one that computers can understand.  We call such
languages "programming languages".  Although Python, PHP, and R are
the most popular programming languages for the digital humanities,
...
filled with parentheses.  Racket comes with an affiliated program
...
@section[#:style 'unnumbered]{Broad themes}
...
@subsection[#:style 'unnumbered]{Data Representation}

 One of the broad problems in the digital humanities
is how to represent data electronically to support a broad variety
of algorithms.  Consider, for example, the markup appropriate for
an electronic version of a book.  It's clear that we want to provide
the textual content of the book.  But an algorithm should be able
to easily access the "parts" of that book, not just chapters, but
also section headings, authors, and so on and so forth.  Scholars
of the book might care about the details of the layout, including
the positions of line and page breaks or the typeface choices
throughout the book.  And, while a book may exist in the abstract,
we may also want to encode the information associated with a
particular printed instance of the book, including the marginalia
and the ownership history, if available.
...
@subsection[#:style 'unnumbered]{Authoring algorithmic texts}

Your daily experience with the Web tells you that computers have
changed how people write, from the abbreviated text of Twitter and
SMS messages to the multiply linked documents of Wikipedia and the
World Wide Web.  We will explore various techniques for building
"algorithmically supported" documents, documents that draw some of
their content from algorithms, such as algorithms that analyze or
reframe other documents.

@subsection[#:style 'unnumbered]{Textual analysis}  

Algorithms are core to the study of computer science.  Hence, the
design of algorithms that we can use to analyze and manipulate texts
form the core of the course.  These algorithms will, of course,
rely on the ways in which we choose to represent data.  And they
can be used in the service of the documents we author.  We will
consider seemingly straightforward issues of textual analysis, such
as word frequencies, as well as the complexities they raise, such
as identifying words with similar stems.  We will also explore more
complex algorithms, including primary aspects of topic modeling.

@section[#:style 'unnumbered]{Context}
...
of missed opportunities for other approaches and techniques.

One of the kinds of difference that many often miss is that of
difference in physical ability.  As developers find themselves
excited by new technologies and new opportunities, they forget to
consider how others might encounter those technologies, particularly
those who have limited sight, limited hearing, or limited movement.
The digital humanities also find themselves hampered by the lure
of new technologies; far too many digital humanities projects are
inaccessible to the differently abled, whether they represent highly
visual interfaces that cannot be used by the visually impaired, or
archives of auditory materials that lack transcripts, or complex
user interfaces.  Whenever possible, we will ask ourselves whether
the approaches we are using are broadly accessible and, if they are
not, we will consider ways in which we could make them more accessible.

@section[#:style 'unnumbered]{Looking ahead}
